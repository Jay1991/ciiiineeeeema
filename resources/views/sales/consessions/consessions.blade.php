...
<script src="{{ asset('js/saleAgent.js') }}" type="text/javascript"></script>
...
<!-- Angular-visual-keyboard -->
<link href="{{ asset('lib/angular-virtual-keyboard/release/angular-virtual-keyboard.css') }}" rel='stylesheet' />
...
<!-- Angular-visual-keyboard -->
<!-- <script src="{{ asset('lib/angular-virtual-keyboard/release/angular-virtual-keyboard.min.js') }}"></script> -->
<script src="{{ asset('lib/angular-virtual-keyboard/release/angular-virtual-keyboard.js') }}"></script>
