...
<html ng-app="app">
 ...
 -->
  ...
  <body class="skin-blue sidebar-mini" style="color:#888;">
  <!-- font-family:ubuntu condensed; -->
  <!-- font: 400 15px/15px 'Roboto', sans-serif;color:#888 -->
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li class="activeX"><a href="index2.html"><i class="fa fa-circle-o"></i> Dashboard v2</a></li>
              </ul>
            </li>
            <li><a href="#reports"><i class="fa fa-pie-chart"></i> <span>Reports</span></a>
            </li>
            <li class="treeview">
              <a href="#">
            ...
            <li>
             ...
             <li>
              <a href="#users">
                ...
                <small class="label pull-right bg-yellow"> @{{ users.length }} </small>
              </a>
            </li>
            <li>
              <a href="#directors">
                <i class="fa fa-envelope"></i> <span>Directors</span>
                <small class="label pull-right bg-yellow"> @{{ directors.length }} </small>
              </a>
            </li>
            <li>
              <a href="#screens">
                <i class="fa fa-envelope"></i> <span>Screens</span>
                <small class="label pull-right bg-yellow"> @{{ screens.length }} </small>
              </a>
            </li>
            <li>
              <a href="#consessions">
            ...
            <li><a href="#/settings"><i class="glyphicon glyphicon-cog"></i> <span>Settings</span></a>
            </li>
