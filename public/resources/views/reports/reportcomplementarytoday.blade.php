  ...
  <section id="inner-banner">
    <div class="container">
      <h1>
         ...
         <small style="color:#fff">To Day</small>
      </h1>
    </div>
  </section>
  <!--INNER BANNER END-->
...
<!--                    <li style="cursor:pointer" ng-click="flagNoteEventListener('Movie Report',1)"><a href=""># Complementary Tickets </a> <span class="label label-primary"> {{ (reports| filter:{'is_complementary': 1 }).length }}</span></li>-->
                ...
                <ol class="breadcrumb pull-right">
                  <li><a href="{{host}}/excel/complementarytoday"><i class="fa fa-file-excel-o fa-2x" aria-hidden="true"></i></a></li>
...
<!--                                {{ profitEventListener((totalSellingEventListener(reports) - totalDiscountEventHandle(reports)), totalBuyingEventListener(reports)) | number:2 }} -->
                                ...
                                {{ getTotalProfit(complementaryToday) | number:2 }}
                                </span></a>
                            </li>
                ...
                <div class="box-body no-padding">
                  ...
                  <div class="table-responsive mailbox-messages">
                    <table
                      ...
                      <tbody >
                        <tr ng-repeat="movie in complementaryToday">
                        ...
                        <tr>
                          ...
                          <td></td>
                          <td></td>
                          <td>{{ getTotalTks(complementaryToday) | number:0 }}</td>
                          <td></td>
                          <td>{{ getAmtIncl(complementaryToday) | number:0 }}</td>
                          <td>{{ getTax(complementaryToday) | number:0 }}</td>
                          <td></td>
                          <td></td>
                          <td>{{ getTotalNet(complementaryToday) | number:0 }}</td>
                          <td></td>
                          <td>{{ getTotalDisCom(complementaryToday) | number:0 }}</td>
                          <td></td>
                        </tr>
                      </tbody>
                    </table>
