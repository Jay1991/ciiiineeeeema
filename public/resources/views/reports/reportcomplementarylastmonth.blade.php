  ...
  <section id="inner-banner">
    <div class="container">
      <h1>
         ...
         <small style="color:#fff">Last Month</small>
      </h1>
    </div>
  </section>
  <!--INNER BANNER END-->
...
-->
                ...
                <ol class="breadcrumb pull-right">
                  <li><a href="{{host}}/excel/complementarylastmonth"><i class="fa fa-file-excel-o fa-2x" aria-hidden="true"></i></a></li>
...
<!--                                {{ profitEventListener((totalSellingEventListener(reports) - totalDiscountEventHandle(reports)), totalBuyingEventListener(reports)) | number:2 }} -->
                                ...
                                {{ getTotalProfit(complementaryLastMonth) | number:2 }}
                                </span></a></li>
                ...
                <div class="box-body no-padding">
                  ...
                  <div class="table-responsive mailbox-messages">
                    <table
                      ...
                      <tbody >
                        <tr ng-repeat="movie in complementaryLastMonth">
                        ...
                        <tr>
                          ...
                          <td></td>
                          <td></td>
                          <td>{{ getTotalTks(complementaryLastMonth) | number:0 }}</td>
                          <td></td>
                          <td>{{ getAmtIncl(complementaryLastMonth) | number:0 }}</td>
                          <td>{{ getTax(complementaryLastMonth) | number:0 }}</td>
                          <td></td>
                          <td></td>
                          <td>{{ getTotalNet(complementaryLastMonth) | number:0 }}</td>
                          <td></td>
                          <td>{{ getTotalDisCom(complementaryLastMonth) | number:0 }}</td>
                          <td></td>
                        </tr>
                      </tbody>
                    </table>
