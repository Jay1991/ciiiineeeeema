...
-->
                ...
                <ol class="breadcrumb pull-right">
                  <li><a href="{{host}}/excel/movielastthirty"><i class="fa fa-file-excel-o fa-2x" aria-hidden="true"></i></a></li>
                    ...
                    <table datatable="ng" 
                      ...
                      <thead>
                        ...
                        <tr>
                          ...
                          <th></th>
                          <th></th>
                          <th>{{ getTotalTks(Thirty) | number:0 }}</th>
                          <th></th>
                          <th>{{ getAmtIncl(Thirty) | number:0 }}</th>
                          <th>{{ getTax(Thirty) | number:0 }}</th>
                          <th></th>
                          <th></th>
                          <th>{{ getTotalNet(Thirty) | number:0 }}</th>
                          <th></th>
                          <th>{{ getTotalDisCom(Thirty) | number:0 }}</th>
                          <th></th>
                        </tr>
                      </tfoot>
                      <tbody >
                        <tr ng-repeat="movie in Thirty">
