<!--INNER BANNER START-->
  <section id="inner-banner">
    <div class="container">
      <h1>
         Movie Report -
         <small style="color:#fff">Last 7 Days</small>
      </h1>
    </div>
  </section>
  <!--INNER BANNER END-->
...
-->
                ...
                <ol class="breadcrumb pull-right">
                  <li><a href="{{host}}/excel/movielastseven"><i class="fa fa-file-excel-o fa-2x" aria-hidden="true"></i></a></li>
                        ...
                        <div class="box-body no-padding">
                          <ul class="nav nav-pills nav-stacked">
                            ...
                            <li ><a href=""><i class="fa fa-inbox"></i> Total buying <span class="label label-primary pull-right">{{ setting.currency_symbol }} 
                                     ...
                                     {{ getTotalBuying(Seven) | number:2 }} 
<!--                                {{ totalBuyingEventListener(reports).toLocaleString() }}-->
                                </span></a></li>
...
<!--                                {{ totalDiscountEventHandle(reports) | number:2 }} -->
                                      {{ getTotalDiscount(Seven) | number:2 }}
...
<!--
                            <li ><a href=""><i class="fa fa-inbox"></i>  net <span class="label label-primary pull-right">{{ setting.currency_symbol }}
                              {{ (totalSellingEventListener(reports) - totalDiscountEventHandle(reports)) | number:2 }}
                                 {{ netEventListener(totalSellingEventListener(reports),totalVATEventListener(reports)).toLocaleString() }}   </span></a>
                              </li>
-->

                            <li ><a href=""><i class="fa fa-inbox"></i>  Profit <span class="label label-primary pull-right">
                                {{ setting.currency_symbol }}
                                
<!--                                {{ profitEventListener((totalSellingEventListener(reports) - totalDiscountEventHandle(reports)), totalBuyingEventListener(reports)) | number:0 }}-->
                                {{ getTotalProfit(Seven) | number:2 }}
                    ...
                    <table datatable="ng" 
                      ...
                      <thead>
                        ...
                        <tr>
                          ...
                          <th></th>
                          <th></th>
                          <th>{{ getTotalTks(Seven) | number:0 }}</th>
                          <th></th>
                          <th>{{ getAmtIncl(Seven) | number:0 }}</th>
                          <th>{{ getTax(Seven) | number:0 }}</th>
                          <th></th>
                          <th></th>
                          <th>{{ getTotalNet(Seven) | number:0 }}</th>
                          <th></th>
                          <th>{{ getTotalDisCom(Seven) | number:0 }}</th>
                          <th></th>
                        </tr>
                      </tfoot>
                      <tbody >
                        <tr ng-repeat="movie in Seven">
