...
-->
                ...
                <ol class="breadcrumb pull-right">
                  <li><a href="{{host}}/excel/moviethismonth"><i class="fa fa-file-excel-o fa-2x" aria-hidden="true"></i></a></li>
                    ...
                    <table
                     ...
                     <tfoot>
                        <tr>
                          ...
                          <th></th>
                          <th></th>
                          <th>{{ getTotalTks(myWelcome) | number:0 }}</th>
                          <th></th>
                          <th>{{ getAmtIncl(myWelcome) | number:0 }}</th>
                          <th>{{ getTax(myWelcome) | number:0 }}</th>
                          <th></th>
                          <th></th>
                          <th>{{ getTotalNet(myWelcome) | number:0 }}</th>
                          <th></th>
                          <th>{{ getTotalDisCom(myWelcome) | number:0 }}</th>
                          <th></th>
                        </tr>
                      </tfoot>
                      <tbody >
                        <tr ng-repeat="movie in myWelcome">
