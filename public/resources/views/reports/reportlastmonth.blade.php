...
-->
                ...
                <ol class="breadcrumb pull-right">
                  <li><a href="{{host}}/excel/movielastmonth"><i class="fa fa-file-excel-o fa-2x" aria-hidden="true"></i></a></li>
                    ...
                    <table datatable="ng" 
                      ...
                      <thead>
                        ...
                        <tr>
                          ...
                          <th></th>
                          <th></th>
                          <th>{{ getTotalTks(lastMonth) | number:0 }}</th>
                          <th></th>
                          <th>{{ getAmtIncl(lastMonth) | number:0 }}</th>
                          <th>{{ getTax(lastMonth) | number:0 }}</th>
                          <th></th>
                          <th></th>
                          <th>{{ getTotalNet(lastMonth) | number:0 }}</th>
                          <th></th>
                          <th>{{ getTotalDisCom(lastMonth) | number:0 }}</th>
                          <th></th>
                        </tr>
                      </tfoot>
                      <tbody >
                        <tr ng-repeat="movie in lastMonth">
