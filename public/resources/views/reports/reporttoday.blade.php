...
-->
                ...
                <ol class="breadcrumb pull-right">
                  <li><a href="{{host}}/excel/movietoday"><i class="fa fa-file-excel-o fa-2x" aria-hidden="true"></i></a></li>
                    ...
                    <table datatable="ng" 
                      ...
                      <tfoot>
                        <tr>
                          ...
                          <th></th>
                          <th></th>
                          <th>{{ getTotalTks(Today) | number:0 }}</th>
                          <th></th>
                          <th>{{ getAmtIncl(Today) | number:0 }}</th>
                          <th>{{ getTax(Today) | number:0 }}</th>
                          <th></th>
                          <th></th>
                          <th>{{ getTotalNet(Today) | number:0 }}</th>
                          <th></th>
                          <th>{{ getTotalDisCom(Today) | number:0 }}</th>
                          <th></th>
                        </tr>
                      </tfoot>
                      <tbody >
                        <tr ng-repeat="movie in Today">
