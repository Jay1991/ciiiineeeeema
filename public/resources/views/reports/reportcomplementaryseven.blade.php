...
-->
                ...
                <ol class="breadcrumb pull-right">
                  <li><a href="{{host}}/excel/complementarylastseven"><i class="fa fa-file-excel-o fa-2x" aria-hidden="true"></i></a></li>
...
<!--                                {{ profitEventListener((totalSellingEventListener(reports) - totalDiscountEventHandle(reports)), totalBuyingEventListener(reports)) | number:2 }} -->
                                ...
                                {{ getTotalProfit(complementarySeven) | number:2 }}
                                </span></a></li>
                ...
                <div class="box-body no-padding">
                  ...
                  <div class="table-responsive mailbox-messages">
                    <table
                      ...
                      <tbody >
                        <tr ng-repeat="movie in complementarySeven">
                        ...
                        <tr>
                          ...
                          <td></td>
                          <td></td>
                          <td>{{ getTotalTks(complementarySeven) | number:0 }}</td>
                          <td></td>
                          <td>{{ getAmtIncl(complementarySeven) | number:0 }}</td>
                          <td>{{ getTax(complementarySeven) | number:0 }}</td>
                          <td></td>
                          <td></td>
                          <td>{{ getTotalNet(complementarySeven) | number:0 }}</td>
                          <td></td>
                          <td>{{ getTotalDisCom(complementarySeven) | number:0 }}</td>
                          <td></td>
                        </tr>
                      </tbody>
                    </table>
