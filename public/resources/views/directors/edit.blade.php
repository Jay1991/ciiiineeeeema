 <span ng-init="name=director.name"></span> 
 <!-- Content Header (Page header) -->
        ...
        <section class="content">
          <div class="row">
            <div class="col-md-3">
              <a href="#/directors" class="btn btn-primary btn-block margin-bottom">Back to Home Page</a>
              ...
              <div class="box box-primary">
                ...
                <div class="box-body">
                  <div class="form-group">
                    <input class="form-control" placeholder="Name:" ng-model="name"/>
                  </div>
                  <div class="form-group">
                ...
                <div class="box-footer">
                  <div class="pull-right">
                    ...
                    <button type="button" class="btn btn-primary" ng-click="updateDirectorEventListener(director,name)"><i class="glyphicon glyphicon-floppy-save"></i> Save</button>
                  </div>
