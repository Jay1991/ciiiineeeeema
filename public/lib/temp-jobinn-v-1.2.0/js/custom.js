...
//    "use strict";
	...
	if ($('.txtEditor').length) {
	$(".txtEditor").Editor();
        $('.Editor-editor').html($('input[name="summary"]').val());
        $('.Editor-editor').html($('input[name="job_description"]').val()); 
	}

    if ($('.txtEditorPrivancy').length) {
    $(".txtEditorPrivancy").Editor();
    $('.Editor-editor').eq(1).html($('input[name="privancy"]').val());
               
    }


    if ($('.txtEditorOurTerm').length) {
        $(".txtEditorOurTerm").Editor();
        $('.Editor-editor').eq(0).html($('input[name="term_condition"]').val());
    }


    if ($('.txtEditorHowItWork').length) {
        $(".txtEditorHowItWork").Editor();
        $('.Editor-editor').eq(2).html($('input[name="how_it_work"]').val());
    }
